  ...
  return (
    <div className="p-6">
      ...
      <form
        ...
        className="mb-6 flex flex-col gap-2 md:flex-row md:items-end"
      >
        <div>
          ...
          {assets.map((a) => (
            ...
            >
              ...
              <figcaption className="p-2 text-xs break-words">
                <div className="font-medium truncate" title={a.url}>
                  {a.url.split("/").pop()}
                </div>
                ...
                {a.tags?.length ? (
                  <div className="mt-1 flex flex-wrap gap-1">
                    {a.tags.map((t) => (
                      <span key={t} className="bg-gray-200 px-1 rounded">
                        {t}
                      </span>
                    ))}
                  </div>

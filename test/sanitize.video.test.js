...
import { sanitize } from "../backend/_lib/sanitize.js";

describe("sanitize video embedding", () => {
  const yt =
    '<p>Intro</p><iframe src="https://www.youtube.com/embed/abc123" width="560" height="315" allowfullscreen title="Video"></iframe><p>After</p>';
  const vimeo =
    '<iframe src="https://player.vimeo.com/video/987654" frameborder="0"></iframe>';
  const bad =
    '<iframe src="https://evil.com/embed/malware" allow="autoplay"></iframe>';

// Rename to avoid shadowing built-in global crypto
...
function withTransform(handler, { camel = true, cacheSeconds = 0 } = {}) {
  return async (req, res) => {
    ...
    // Buffer retained only if future streaming/size metrics needed; omitted to avoid unused var warning
    // Monkey patch
    res.json = function (obj) {
      let payloadObj = obj;
      if (camel && obj && typeof obj === "object") {
        if (Array.isArray(obj))
          payloadObj = obj.map((o) =>

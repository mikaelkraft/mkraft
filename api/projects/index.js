...
module.exports = async function handler(req, res) {
  try {
    ...
    if (req.method === 'POST') {
      ...
      `;
      const params = [
        body.title || '', body.description || null, body.featured_image || null,
        body.gallery_images || null, body.type || 'image', body.video_url || null,
        body.video_poster || null, body.tags || null, body.category || null,
        body.status || 'draft', !!body.featured, user.id
      ];
    ...
    if (req.method === 'PUT') {
      ...
      const params = [
        id,
        body.title ?? null, body.description ?? null, body.featured_image ?? null,
        body.gallery_images ?? null, body.type ?? null, body.video_url ?? null,
        body.video_poster ?? null, body.tags ?? null, body.category ?? null,
        body.status ?? null, (typeof body.featured === 'boolean' ? body.featured : null)
      ];

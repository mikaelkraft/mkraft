...
module.exports = async function handler(req, res) {
  ...
  if (row.logo_url && !row.site_logo_url) row.site_logo_url = row.logo_url; // alias
      ...
      if (!row.logo_light_url) row.logo_light_url = row.site_logo_url || row.logo_url || null;
      if (!row.logo_dark_url) row.logo_dark_url = row.site_logo_url || row.logo_url || null;
      if (!row.og_default_image_url) row.og_default_image_url = row.site_logo_url || row.logo_url || null;
  ...
  if (body.ads_settings && !body.ads) body.ads = body.ads_settings;
      ...
      if (existing.rows.length) {
        ...
        const params = [body.site_title||null, body.site_tagline||null, body.site_description||null, body.contact_email||null, body.admin_email||null, body.enable_video??null, body.default_theme||null, body.default_font_size||null, body.logo_url||null, body.favicon_url||null, body.resume_url||null, body.hero_image_url||null, body.social_media||null, body.seo_settings||null, body.maintenance_mode??null, body.custom_css||null, body.custom_js||null, body.ui||null, body.ads||null, body.logo_light_url||null, body.logo_dark_url||null, body.og_default_image_url||null, id];
        const { rows } = await query(updateSql, params);
  const out = rows[0];
  if (out.logo_url && !out.site_logo_url) out.site_logo_url = out.logo_url;
        if (!out.logo_light_url) out.logo_light_url = out.site_logo_url || out.logo_url;
        if (!out.logo_dark_url) out.logo_dark_url = out.site_logo_url || out.logo_url;
        if (!out.og_default_image_url) out.og_default_image_url = out.site_logo_url || out.logo_url;
        ...
        const params = [body.site_title||null, body.site_tagline||null, body.site_description||null, body.contact_email||null, body.admin_email||null, body.enable_video??null, body.default_theme||null, body.default_font_size||null, body.logo_url||null, body.favicon_url||null, body.resume_url||null, body.hero_image_url||null, body.social_media||null, body.seo_settings||null, body.maintenance_mode??null, body.custom_css||null, body.custom_js||null, body.ui||null, body.ads||null, body.logo_light_url||null, body.logo_dark_url||null, body.og_default_image_url||null];
